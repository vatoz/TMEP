<?php
  ...
  $qj = MySQLi_query($GLOBALS["DBC"], "SELECT den, nejvyssi, nejnizsi, prumer FROM tme_denni WHERE zarizeni=".ZARIZENI." ORDER BY den DESC LIMIT 0, 31");
...
$(function () {
    ...
    $(document).ready(function() {
        chart = new Highcharts.Chart({
            chart: { renderTo: 'graf-31-dni-teplota', zoomType: 'x', backgroundColor: '#ffffff', borderRadius: 0 },
            credits: { enabled: 0 },
