<?php
  ...
  if($vlhkomer == 1)
  {
    ...
    echo "</div><div class='container'>
      ...
      <tr class='zelenyRadek'>
        <td colspan='2'><a href='./scripts/modals/mesicniStatistiky.php?je=".$_GET['je']."&amp;ja=".$_GET['ja']."' class='modal bilyOdkaz'>{$lang['nejteplejsimesice']}</a></td>
      </tr>
      <tr class='modryRadek'>
    ...
    echo "</table></div>";
        ...
        echo "<div class='col-md-3 perc22'>
              <table class='tabulkaVHlavicce'>
          <tr class='zelenyRadek'>
            <td colspan='2' class='radek'><a href='./scripts/modals/mesicniStatistiky.php?je=".$_GET['je']."&amp;ja=".$_GET['ja']."' class='modal bilyOdkaz'>{$lang['nejchladnejsimesice']}</a></td>
          </tr>
          <tr class='modryRadek'>
            <td class='radek'>{$lang['mesic']}</td>
            <td class='radek'>{$lang['prumernateplota']}</td>
  ...
  $qStat = MySQLi_query($GLOBALS["DBC"], "SELECT den, AVG(prumer_vlhkost) as prumer
        ...
        echo "<div class='col-md-3 perc22'>
              <table class='tabulkaVHlavicce'>
              <tr class='zelenyRadek'>
                <td colspan='2' ><a href='./scripts/modals/mesicniStatistiky.php?je=".$_GET['je']."&amp;ja=".$_GET['ja']."' class='modal bilyOdkaz'>{$lang['nejvlhcimesice']}</a></td>
              </tr>
              <tr class='modryRadek'>
                <td class='radek'>{$lang['mesic']}</td>
